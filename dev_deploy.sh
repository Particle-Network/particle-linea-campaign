...
yarn \
    ...
    && curl -X POST -H "Content-Type: application/json" \
        -d '{"msg_type":"post","content":{"post":{"zh_cn":{"title":"Combo Campaign 测试环境","content":[[{"tag":"text","text":"项目有更新: "},{"tag":"a","text":"请查看","href":"https://combo-testnet-debug.app-link.network/"}]]}}}}' \
